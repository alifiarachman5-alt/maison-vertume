...
<head>
    ...
    <title>Maison Vertumne - E-Shop Grief</title>
    ...
    <main class="eshop-container">
        ...
        <section class="content-wrapper">
            <aside class="sidebar">
                <nav>
                    <ul>
                        <li><a href="eshop-grief.php" class="active">Grief</a></li>
            ...
            <div class="product-grid">
                ...
                <div class="product-item">
                    <div class="img-holder"><img src="../image/g01.jpg" alt="Basket"></div>
                    <h3>Basket</h3>
                    <p>Starting from €250.00</p>
                    <button class="btn-add" onclick="addToCart('Basket', 250, '../image/g01.jpg')">Add to Cart</button>
                </div>

                <div class="product-item">
                    <div class="img-holder"><img src="../image/g02.jpg" alt="Heart"></div>
                    <h3>Heart</h3>
                    <p>Starting from €400.00</p>
                    <button class="btn-add" onclick="addToCart('Heart', 400, '../image/g02.jpg')">Add to Cart</button>
                </div>

                <div class="product-item">
                    <div class="img-holder"><img src="../image/g04.jpg" alt="High composition"></div>
                    <h3>High composition</h3>
                    <p>Starting from €200.00</p>
                    <button class="btn-add" onclick="addToCart('High composition', 200, '../image/g04.jpg')">Add to Cart</button>
                </div>

                <div class="product-item">
                    <div class="img-holder"><img src="../image/g03.jpg" alt="Crown"></div>
                    <h3>Crown</h3>
                    <p>Starting from €600.00</p>
                    <button class="btn-add" onclick="addToCart('Crown', 600, '../image/g03.jpg')">Add to Cart</button>
                </div>

                <div class="product-item">
                    <div class="img-holder"><img src="../image/g05.jpg" alt="Coffin lid"></div>
                    <h3>Coffin lid</h3>
                    <p>Starting from €600.00</p>
                    <button class="btn-add" onclick="addToCart('Coffin lid', 600, '../image/g05.jpg')">Add to Cart</button>
                </div>

                <div class="product-item">
                    <div class="img-holder"><img src="../image/g06.jpg" alt="Mourning cross"></div>
                    <h3>Mourning cross</h3>
                    <p>Starting from €800.00</p>
                    <button class="btn-add" onclick="addToCart('Mourning cross', 800, '../image/g06.jpg')">Add to Cart</button>
                </div>
