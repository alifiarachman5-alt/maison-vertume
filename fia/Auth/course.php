...
<head>
    ...
    <title>Maison Vertumne - Course</title>
        ...
        <div class="main-content">
            ...
            <div class="product-grid col-4">
                <div class="product-card">
                    <div class="img-box"><img src="../image/p1.jpg" alt="Privilege Card"></div>
                    <h3>Privilege Card</h3>
                    <p>€195.00</p>
                    <button class="btn-add" onclick="addToCart('Basket', 250, '../image/g01.jpg')">Add to Cart</button>
                </div>
                <div class="product-card">
                    <div class="img-box"><img src="../image/p2.jpg" alt="Single Course Card"></div>
                    <h3>Single Course Card</h3>
                    <p>€95.00</p>
                    <button class="btn-add" onclick="addToCart('Basket', 250, '../image/g01.jpg')">Add to Cart</button>
                </div>
                <div class="product-card">
                    <div class="img-box"><img src="../image/p3.jpg" alt="6-class Subscription Card"></div>
                    <h3>6-class Subscription Card</h3>
                    <p>€450.00</p>
                    <button class="btn-add" onclick="addToCart('Basket', 250, '../image/g01.jpg')">Add to Cart</button>
                </div>
                <div class="product-card">
                    <div class="img-box"><img src="../image/p4.jpg" alt="3-class Subscription Card"></div>
