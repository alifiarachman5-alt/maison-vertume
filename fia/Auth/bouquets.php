...
<head>
    ...
    <title>Maison Vertumne - Bouquets</title>
...
<body>
    ...
    <div class="container">
        <header><h1>MAISON VERTUMNE FLOWERS</h1></header>
        <div class="main-content">
            <aside class="sidebar">
                <nav>
                    <ul>
                        <li><a href="eshop-grief.html">Grief</a></li>
                        <li><a href="bouquets.html" class="active">Bouquets</a></li>
            ...
            <div class="product-grid col-4">
                <div class="product-card">
                    <div class="img-box"><img src="../image/bq1.jpg" alt="Market Bouquet"></div>
                    <h3>Market Bouquet</h3><p>€35.00</p>
                    <button class="btn-add" onclick="addToCart('Basket', 250, '../image/g01.jpg')">Add to Cart</button>
                </div>
                <div class="product-card">
                    <div class="img-box"><img src="../image/bq2.jpg" alt="Bouquet of the Moment"></div>
                    <h3>Bouquet of the Moment</h3><p>€125.00</p>
                    <button class="btn-add" onclick="addToCart('Basket', 250, '../image/g01.jpg')">Add to Cart</button>
                </div>
                <div class="product-card">
                    <div class="img-box"><img src="../image/bq4.jpg" alt="Seasonal Bouquet"></div>
                    <h3>Seasonal Bouquet</h3><p>€150.00</p>
                    <button class="btn-add" onclick="addToCart('Basket', 250, '../image/g01.jpg')">Add to Cart</button>
                </div>
                <div class="product-card">
                    <div class="img-box"><img src="../image/bq3.jpg" alt="Signature Bouquet"></div>
                    <h3>Signature Bouquet</h3><p>€200.00</p>
                    <button class="btn-add" onclick="addToCart('Basket', 250, '../image/g01.jpg')">Add to Cart</button>
                </div>
            </div>
        </div>
